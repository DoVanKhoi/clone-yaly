...
export default function Header() {
    ...
    const menu = [
        ...
        { label: "Header.menu.tailoring-guide", path: "tailoring-guide" },
        { label: "Header.menu.catalog", path: "catalog" },
        { label: "Header.menu.news", path: "news" },
                    ...
                    <div className="flex items-center ml-10 md:ml-0 gap-1 md:gap-6 text-zinc-600">
                        ...
                        <div>
                            <Dialog>
                                ...
                                <DialogOverlay className="fixed inset-0 bg-black/50 z-150" />
                                <DialogContent
                                    showCloseButton={false}
                                    className="max-w-md p-0 overflow-hidden fixed z-9999"
                                >
                                    <VisuallyHidden>
                                        <DialogTitle className="sr-only">
                                            {tab === "register" ? "Đăng ký tài khoản YALY" : "Đăng nhập tài khoản YALY"}
                                        </DialogTitle>
                                    ...
                                    <div className="flex border-b">
                                        <button
                                            ...
                                            className={`w-1/2 py-4 text-center font-semibold border-b-2 transition
                                                    ${tab === "register"
