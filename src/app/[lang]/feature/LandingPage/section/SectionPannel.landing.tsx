...
import { Background1, Background2, Background3, Background4, Background5 } from "@/public/images";
        ...
        <>
            {listPannel.map((pannel, index) => (
                ...
                >
                    ...
                    <a className="text-3xl font-bold uppercase text-[#333] bg-white px-4 py-3 text-center rounded"
                        href="#"
                    >
                        {pannel.link_VN}
                    </a>
