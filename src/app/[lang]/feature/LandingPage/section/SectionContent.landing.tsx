                ...
                <div className="flex flex-col lg:flex-row items-center gap-8">
                    ...
                    <div className="w-full lg:w-1/2 text-zinc-700">
                        ...
                        <p className="text-base md:text-lg leading-relaxed mb-6 wrap-break-word">
                            ...
                            Rigorous in-house training ensures excellence from measurements to final products. Our craftsmen guarantees
                            expertise in creating stunning, individualized garments at affordable price without compromising our
                            exceptional quality standard. Let's explore in detail the high-end bespoke tailoring process at Yaly Couture,
            ...
            {Array.from({ length: 6 }).map((_, index) => (
                ...
                >
                    ...
                    >
                        ...
                        {/* TITLE */}
                        <h3
                            className="text-3xl md:text-4xl lg:text-5xl font-medium text-zinc-700 text-center"
                        >
                            TEST
                        </h3>
